...
echo ""
echo "Run the following two (blocking) commands in two different terminals"
echo "1. Run the backend using:"
echo "   cd checkout"
echo "   ng serve --proxy-config proxy.conf.json"
echo "2. Build/run the frontend (in the /dist-folder) using"
echo "   cd node-api"
echo "   npm start"